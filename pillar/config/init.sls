...
salt:
  ...
  minion:
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # Can be set to same, which will process only the top file from the
    # environment that the minion belongs to via the environment configuration
    # setting or the environment that is requested via the saltenv argument
    # supported by some functions in the state module.
    # 
    # Can also be set to merge. This is the default. When set to merge, top
    # files will be merged together. The order in which top files are merged
    # together can be controlled with env_order.
    # ──────────────────────────────────────────────────────────────────────────
